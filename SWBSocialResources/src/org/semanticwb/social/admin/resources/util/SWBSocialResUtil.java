...
public class SWBSocialResUtil {
    ...
    public static class Util {
        ...
        /**
         * Reemplaza caracteres especiales, tal como lo hace la misma función
         * desde el SWBUtils, solo que esta función si deja los espacios en
         * blanco, cosa que la del SWBUtils no hace., de hecho me parece que es
         * un bug., decirle a Javier despues.
         */
        ...
        /**
         * Reemplaza caracteres especiales, tal como lo hace la misma función
         * desde el SWBUtils, solo que esta función tiene la opción de dejar los
         * espacios en blanco. Dado que la libreria Jsoup al eliminar todos los
         * tags de html de un texto devuelve los acentos y las tildes
         * condificados en HTML entonces se reemplazan por el caracter en ASCII.
         * Se mantienen los acentos en las vocales dado que la búsqueda en el
         * stream y social topic distingue los acentos. //TODO: ver si se le
         * quitan los ACENTOS cuando se hace el String.contains('PALABRA A
         * BUSCAR')
         */
        ...
        public static Iterator getFilterDates(Iterator itPost, Date sinceDateAnalysis, Date toDateAnalysis) {
            ...
            while (itPost.hasNext()) {
                PostIn postIn = (PostIn) itPost.next();
