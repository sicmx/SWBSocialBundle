...
public abstract class PostInContainerBase extends org.semanticwb.model.SWBClass implements org.semanticwb.model.Traceable,org.semanticwb.model.Descriptiveable
{
   ...
   */
    public static final org.semanticwb.platform.SemanticClass sclass=org.semanticwb.SWBPlatform.getSemanticMgr().getVocabulary().getSemanticClass("http://www.semanticwebbuilder.org/swb4/social#PostInContainer");

    public static class ClassMgr
    {
       /**
       * Returns a list of PostInContainer for a model
       * @param model Model to find
       * @return Iterator of org.semanticwb.social.PostInContainer
       */

        public static java.util.Iterator<org.semanticwb.social.PostInContainer> listPostInContainers(org.semanticwb.model.SWBModel model)
        {
            java.util.Iterator it=model.getSemanticObject().getModel().listInstancesOfClass(sclass);
            return new org.semanticwb.model.GenericIterator<org.semanticwb.social.PostInContainer>(it, true);
        }
       /**
       * Returns a list of org.semanticwb.social.PostInContainer for all models
       * @return Iterator of org.semanticwb.social.PostInContainer
       */

        public static java.util.Iterator<org.semanticwb.social.PostInContainer> listPostInContainers()
        {
            java.util.Iterator it=sclass.listInstances();
            return new org.semanticwb.model.GenericIterator<org.semanticwb.social.PostInContainer>(it, true);
        }

        public static org.semanticwb.social.PostInContainer createPostInContainer(org.semanticwb.model.SWBModel model)
        {
            long id=model.getSemanticObject().getModel().getCounter(sclass);
            return org.semanticwb.social.PostInContainer.ClassMgr.createPostInContainer(String.valueOf(id), model);
        }
       /**
       * Gets a org.semanticwb.social.PostInContainer
       * @param id Identifier for org.semanticwb.social.PostInContainer
       * @param model Model of the org.semanticwb.social.PostInContainer
       * @return A org.semanticwb.social.PostInContainer
       */
        public static org.semanticwb.social.PostInContainer getPostInContainer(String id, org.semanticwb.model.SWBModel model)
        {
            return (org.semanticwb.social.PostInContainer)model.getSemanticObject().getModel().getGenericObject(model.getSemanticObject().getModel().getObjectUri(id,sclass),sclass);
        }
       /**
       * Create a org.semanticwb.social.PostInContainer
       * @param id Identifier for org.semanticwb.social.PostInContainer
       * @param model Model of the org.semanticwb.social.PostInContainer
       * @return A org.semanticwb.social.PostInContainer
       */
        public static org.semanticwb.social.PostInContainer createPostInContainer(String id, org.semanticwb.model.SWBModel model)
        {
            return (org.semanticwb.social.PostInContainer)model.getSemanticObject().getModel().createGenericObject(model.getSemanticObject().getModel().getObjectUri(id,sclass),sclass);
        }
       /**
       * Remove a org.semanticwb.social.PostInContainer
       * @param id Identifier for org.semanticwb.social.PostInContainer
       * @param model Model of the org.semanticwb.social.PostInContainer
       */
        public static void removePostInContainer(String id, org.semanticwb.model.SWBModel model)
        {
            model.getSemanticObject().getModel().removeSemanticObject(model.getSemanticObject().getModel().getObjectUri(id,sclass));
        }
       /**
       * Returns true if exists a org.semanticwb.social.PostInContainer
       * @param id Identifier for org.semanticwb.social.PostInContainer
       * @param model Model of the org.semanticwb.social.PostInContainer
       * @return true if the org.semanticwb.social.PostInContainer exists, false otherwise
       */

        public static boolean hasPostInContainer(String id, org.semanticwb.model.SWBModel model)
        {
       ...
       */
       ...
       /**
       * Gets all org.semanticwb.social.PostInContainer with a determined Plc_Post
       * @param value Plc_Post of the type org.semanticwb.social.PostIn
       * @param model Model of the org.semanticwb.social.PostInContainer
       * @return Iterator with all the org.semanticwb.social.PostInContainer
       */

        public static java.util.Iterator<org.semanticwb.social.PostInContainer> listPostInContainerByPlc_Post(org.semanticwb.social.PostIn value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.social.PostInContainer> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(social_hasPlc_Post, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.social.PostInContainer with a determined Plc_Post
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.social.PostInContainer> listPostInContainerByPlc_Post(org.semanticwb.social.PostIn value)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.social.PostInContainer> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(social_hasPlc_Post,value.getSemanticObject(),sclass));
            return it;
        }
       /**
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.social.PostInContainer> listPostInContainerByCreator(org.semanticwb.model.User value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.social.PostInContainer> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swb_creator, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.social.PostInContainer with a determined Creator
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.social.PostInContainer> listPostInContainerByCreator(org.semanticwb.model.User value)
        {
    ...
    {
        return new PostInContainerBase.ClassMgr();
    }

   /**
   * Constructs a PostInContainerBase with a SemanticObject
   * @param base The SemanticObject with the properties for the PostInContainer
   */
    public PostInContainerBase(org.semanticwb.platform.SemanticObject base)
    {
        super(base);
    }
   /**
