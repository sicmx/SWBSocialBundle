        ...
        try{            
            ...
            if(stream.getGeoCenterLatitude() != 0 && stream.getGeoCenterLongitude() != 0 && stream.getGeoRadio() > 0){
                ...
                if(stream.getGeoRadio() < 50){
                    ...
                    query.setGeoCode(new GeoLocation(stream.getGeoCenterLatitude(), stream.getGeoCenterLongitude()), stream.getGeoRadio(), distance_unit);//(latitude, longitude), radius, units of distance
                }
            }
