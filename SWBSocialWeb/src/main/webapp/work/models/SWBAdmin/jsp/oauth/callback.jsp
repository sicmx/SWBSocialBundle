...
<%
        ...
        if (session.getAttribute("redirectYouTube") != null) {
            response.sendRedirect(session.getAttribute("redirectYouTube") + "?code=" + request.getParameter("code"));
        } else if (session.getAttribute("redirectGoogle") != null) {
            response.sendRedirect(session.getAttribute("redirectGoogle") + "?code=" + request.getParameter("code"));
        }
%> 
