...
<%
    ...
    String sinceDateAnalysisPieCharts = request.getParameter("sinceDateAnalysisPieCharts");
    String toDateAnalysisPieCharts = request.getParameter("toDateAnalysisPieCharts");
    if(sinceDateAnalysisPieCharts != null && !sinceDateAnalysisPieCharts.isEmpty() && toDateAnalysisPieCharts != null && !toDateAnalysisPieCharts.isEmpty()) {
        ...
        try {
            tDateAnalysisPieCharts = formatDate.parse(toDateAnalysisPieCharts);
        } catch(java.text.ParseException e) {
        }
    }
    ...
    args += "&sinceDateAnalysisPieCharts=" +  (sinDateAnalysisPieCharts != null ? formatDate.format(sinDateAnalysisPieCharts) : null);
    args += "&toDateAnalysisPieCharts=" + (tDateAnalysisPieCharts != null ? formatDate.format(tDateAnalysisPieCharts) : null);
...
<%/*
    <div id="pieEducationParent">
        <div class="grafTit">
            ...
            <a id="hrefEducation" href="<=urlRender.setMode("exportExcel").setParameter("type", "education").setCallMethod(SWBParamRequest.Call_DIRECT).setParameter("suri", suri).setParameter("lang", lang)>" onclick="return confirm('øDesea exportar a excel?')"  class="excel">Exportar excel</a>
</div>
        <div id="pieEducation" >
        </div>
        <div class="grafOptions">
...
<div  id="pieRelationParent">
        <div class="grafTit">
            ...
            <a id="hrefRelation" href="<%=urlRender.setMode("exportExcel").setParameter("type", "relation").setCallMethod(SWBParamRequest.Call_DIRECT).setParameter("suri", suri).setParameter("lang", lang)>" onclick="return confirm('øDesea exportar a excel?')"  class="excel">Exportar excel</a>
        </div> 
...
<%/*
    <div id="lifeStageParent">
        <div class="grafTit">
            ...
            <a  id="hrefLife" href="<%=urlRender.setMode("exportExcel").setParameter("type", "lifeStage").setCallMethod(SWBParamRequest.Call_DIRECT).setParameter("suri", suri).setParameter("lang", lang)>" onclick="return confirm('øDesea exportar a excel?')" class="excel">Exportar excel</a>
        </div> 
...
*/%>
    ...
    <div id="profileGeoLocationParent">
        <div class="grafTit">
            <h1><%=SWBSocialResUtil.Util.getStringFromGenericLocale("location", lang)%> MÈxico</h1>
            <a id="hrefGeo" href="<%=urlRender.setMode("exportExcel").setParameter("type", "geoLocation").setCallMethod(SWBParamRequest.Call_DIRECT).setParameter("suri", suri).setParameter("lang", lang).setParameter("country", "MX").setParameter("sinceDateAnalysisPieCharts", (sinDateAnalysisPieCharts != null ? formatDate.format(sinDateAnalysisPieCharts) : null)).setParameter("toDateAnalysisPieCharts",(tDateAnalysisPieCharts != null ? formatDate.format(tDateAnalysisPieCharts) : null))%>" onclick="return confirm('øDesea exportar a excel?')"  class="excel">Exportar excel</a>
        </div> 
    ...
    <div id="profileGeoLocationParentEU">
        <div class="grafTit">
            ...
            <a id="hrefGeoEU" href="<%=urlRender.setMode("exportExcel").setParameter("type", "geoLocation").setCallMethod(SWBParamRequest.Call_DIRECT).setParameter("suri", suri).setParameter("lang", lang).setParameter("country", "US").setParameter("sinceDateAnalysisPieCharts", (sinDateAnalysisPieCharts != null ? formatDate.format(sinDateAnalysisPieCharts) : null)).setParameter("toDateAnalysisPieCharts",(tDateAnalysisPieCharts != null ? formatDate.format(tDateAnalysisPieCharts) : null))%>" onclick="return confirm('øDesea exportar a excel?')" class="excel">Exportar excel</a>
        </div> 
