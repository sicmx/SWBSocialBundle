<%-- 
    Document   : pieMapCountry
    Created on : 26/03/2014, 03:26:45 PM
...
<%!    private static int positivesGlobal = 0;
    ...
    JSONArray getObject(SemanticObject semObj, String lang, String idModel, String fi, String sinceDateAnalysis, String toDateAnalysis) throws Exception {
        ...
        while (i.hasNext()) {
            ...
            map.put(reemplazar(country.getTitle()), new ArrayList<PostIn>());
        ...
        while (itObjPostIns.hasNext()) {
            ...
            if (postIn.getGeoStateMap() == null) {
                ...
                key = postIn.getGeoStateMap().getCountry();
    ...
    public JSONArray getJsonLang(JSONArray node, ArrayList list, int totalPost, String nombre, String lang) throws Exception {
        ...
        if (intPorcentaje == 0) {
            ...
            //   System.out.println("desoues de datsos");
